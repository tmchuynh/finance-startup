...
export default function DebtConsolidationCalculator() {
  ...
  return (
    <div className="mt-8 md:mt-12 mx-auto h-full w-10/12 md:w-11/12">
      ...
      <p className="mb-4">
        <strong>
          Estimate your savings and new monthly payment if you consolidate
      ...
      <section className="mb-8">
        ...
        <p>
          Enter your existing debts (balance, interest rate, monthly payment),
          then enter the consolidation loan's interest rate, term, and fees. The
          calculator compares your current payments and interest to a new
          consolidated loan.
        </p>
        <div className="mb-6">
          ...
          <table className="mb-4 border border-gray-300 min-w-full text-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-3 py-2 border">
                  New payment after consolidation
                </td>
              ...
              <tr>
                ...
                <td className="px-3 py-2 border">
                  Sum of all payments on new loan
                </td>
              ...
              <tr>
                ...
                <td className="px-3 py-2 border">
                  Current total paid - consolidation total paid
                </td>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside">
            <li>
              Debt consolidation can lower your monthly payment and interest,
              but may extend your payoff time.
            </li>
            <li>Compare total interest and fees before consolidating.</li>
            <li>
              Make extra payments to pay off your consolidation loan faster.
            </li>
            <li>Check for origination fees and prepayment penalties.</li>
            <li>
              Consult a financial advisor for personalized debt strategies.
            </li>
          </ul>
        </div>
      </section>
          ...
          <div key={idx} className="gap-4 items-end grid md:grid-cols-4 mb-2">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleDebtChange(idx, "interestRate", e.target.value)
                }
                placeholder="e.g., 18"
                min="0"
                max="100"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleDebtChange(idx, "monthlyPayment", e.target.value)
                }
                placeholder="e.g., 200"
                min="0"
              />
        ...
        <div className="flex flex-col gap-4 mt-6">
          <div className="shadow p-4 border rounded-lg">
            ...
            <table className="border border-gray-300 min-w-full text-sm">
              <tbody>
                <tr>
                  ...
                  <td className="px-3 py-2 border">
                    $
                    {result.totalCurrentMonthly.toLocaleString(undefined, {
                ...
                <tr>
                  ...
                  <td className="px-3 py-2 border">
                    $
                    {result.totalCurrentPaid.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-3 py-2 border">
                    $
                    {result.totalCurrentInterest.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-3 py-2 border">
                    $
                    {result.consolidationMonthly.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
                ...
                <tr>
                  <td className="px-3 py-2 border font-medium">
                    Consolidation Total Paid
                  </td>
                  <td className="px-3 py-2 border">
                    $
                    {result.consolidationTotalPaid.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-3 py-2 border">
                    $
                    {result.consolidationInterest.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </td>
            ...
            <div className="mt-2 text-sm">
              ...
              results may vary based on your debt terms and consolidation loan.
            </div>
          </div>
        </div>
      )}
