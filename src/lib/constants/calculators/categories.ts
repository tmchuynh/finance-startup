...
export const financeCalculatorCategories: Category[] = [
  ...
  },
  {
    ...
    list: [
      ...
      {
        title: "Income and Property and Sales Tax Calculator",
        description:
          "Estimate your income tax, property tax, and sales tax based on your financial situation.",
        id: "income-and-property-and-sales-tax-calculator",
      },
      {
  ...
  },
  {
    ...
    list: [
      {
        title: "Retirement Savings and Income Calculator",
        description:
          "Estimate your retirement savings and income based on your current savings and future contributions.",
        id: "retirement-savings-and-income-calculator",
      },
      {
      ...
      {
        title: "Retirement Withdrawal and Spending Calculator",
        description:
          "Estimate your retirement spending and withdrawal strategy to ensure you don't outlive your savings.",
        id: "retirement-withdrawal-and-spending-calculator",
      },
      {
        title: "Retirement Savings Rate and Investment Growth Calculator",
        description:
          "Estimate the growth of your retirement savings based on your savings rate and investment returns.",
        id: "retirement-savings-rate-and-investment-growth-calculator",
      },
    ],
  },
  {
    ...
    list: [
      {
        title: "Tax Deduction and Tax Refund Calculator",
        description:
          "Estimate your tax deductions and potential tax refund based on your income and expenses.",
        id: "tax-deduction-and-tax-refund-calculator",
      },
      {
        title: "Self-Employment and Taxable Income Calculator",
        description:
          "Estimate your self-employment tax and taxable income based on your earnings.",
        id: "self-employment-tax-and-taxable-income-calculator",
      },
      {
        title: "Tax Withholding and Estimated Tax Payment Calculator",
        description:
          "Determine the right amount of withholding from your paycheck.",
        id: "tax-withholding-and-estimated-tax-payment-calculator",
      },
      {
        title: "Capital Gains and Loss Tax Calculator",
        description:
          "Estimate capital gains and losses for tax purposes based on your investments.",
        id: "capital-gains-and-loss-deduction-tax-calculator",
      },
    ],
  },
  {
    ...
    list: [
      {
        title: "Life and Auto Insurance Calculator",
        description:
          "Estimate your life and auto insurance premiums based on coverage needs and personal factors.",
        id: "life-and-auto-insurance-calculator",
      },
      {
        title: "Homeowners Insurance and Renters Insurance Calculator",
        description:
          "Estimate homeowners and renters insurance premiums based on property value and location.",
        id: "homeowners-insurance-and-renters-insurance-calculator",
      },
      {
      ...
      {
        title:
          "Long-Term Care Insurance and Health Insurance Premium Insurance Calculator",
        description:
          "Estimate long-term care insurance and health insurance premiums based on age and health status.",
        id: "long-term-care-insurance-and-health-insurance-premium-insurance-calculator",
      },
      {
  ...
  },
  {
    ...
    list: [
      {
        title: "Savings Growth and Savings Rate Calculator",
        description:
          "Estimate the growth of your savings based on your savings rate and investment returns.",
        id: "savings-growth-and-savings-rate-calculator",
      },
      {
      ...
      {
        title: "College Saving Calculator",
        description:
      ...
      },
      {
        ...
        description:
          "Estimate how long your savings will last based on withdrawals.",
        id: "savings-withdrawal-calculator",
      },
      {
        title: "Savings Investment Withdrawal Strategy Calculator",
        description: "Calculate the best withdrawal strategy for your savings.",
        id: "savings-investment-withdrawal-strategy-calculator",
      },
      {
        title:
  ...
  },
  {
    ...
    list: [
      {
        title: "Debt Repayment and Debt Settlement Calculator",
        description:
          "Estimate how long it will take to pay off your debt based on payments and interest rate.",
        id: "debt-repayment-and-debt-settlement-calculator",
      },
      {
        title: "Credit Card Payoff and Credit Card Interest Calculator",
        description:
      ...
      {
        title: "Debt Reduction, Comparison and Relief Calculator",
        description:
          "Estimate the impact of debt reduction strategies on your overall debt.",
        id: "debt-reduction-comparison-and-relief-calculator",
      },
      {
        title:
          "Debt-to-Equity and Debt-to-Asset and Debt-to-Income Ratio Calculator",
        description:
          "Calculate your debt-to-equity and debt-to-asset and debt-to-income ratios to assess your financial leverage.",
        id: "debt-to-equity-and-debt-to-asset-and-debt-to-income-ratio-calculator",
      },
    ],
  },
];
